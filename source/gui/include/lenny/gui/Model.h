...
public:
    ...
    public:
        ...
        void draw(const std::optional<Eigen::Vector3d> &color, bool isSpaceShip, bool isChangeScenery) const;
...
public:
    ...
    void changeScenery(int mode, float refractionRatio = 1);
    ...
    void draw(const Eigen::Vector3d &position, const Eigen::QuaternionD &orientation, const Eigen::Vector3d &scale, const std::optional<Eigen::Vector3d> &color,
              const double &alpha, bool isSpaceShip = false, bool isChangeScenery = false) const override;
